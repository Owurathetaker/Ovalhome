...
const PRODUCT_PRICES: Record<Code, number> = {
  "Y-009": 300,
  "F-005": 650,
  "Z-001": 330,
  "Z-002": 340,
        ...
        <div className="overflow-hidden rounded-3xl border border-black/10 bg-white shadow-sm">
          ...
          <div className="p-5 md:p-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Browse designs, see prices instantly, and order directly on WhatsApp.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10">
        <div className="rounded-3xl border border-black/10 bg-white p-5 shadow-sm md:p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600">
            ...
            mirrors in Ghana, you can browse available designs on this page, see prices
            instantly, and order directly on WhatsApp. We offer same-day or next-day
            delivery in Accra and nationwide delivery across Ghana.
          </p>
        </div>
      </section>
